...
public class Sftest3Api {
  ...
  public Tables getTables (Boolean include_properties, String names) throws ApiException {
    ...
    String path = "/sftest3".replaceAll("\\{format\\}","json");
  ...
  public Records getRecords (String table_name, String ids, String filter, Integer limit, Integer offset, String order, String fields, Boolean include_count, String id_field) throws ApiException {
    ...
    // create path and map variables
    String path = "/sftest3/{table_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString()));
  ...
  public String getRecord (String table_name, String id, Boolean properties_only, String id_field, String fields) throws ApiException {
    ...
    // create path and map variables
    String path = "/sftest3/{table_name}/{id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString())).replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
