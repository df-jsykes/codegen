  ...
  namespace Com.Wordnik.Client.Api {
    public class AppApi {
      ...
      public ContainersResponse getContainers (bool include_properties) {
        ...
        var path = "/app".Replace("{format}","json");
      ...
      public ContainerResponse getContainer (string container, bool include_properties, bool include_folders, bool include_files, bool full_tree, bool zip) {
        // create path and map variables
        var path = "/app/{container}/".Replace("{format}","json").Replace("{" + "container" + "}", apiInvoker.escapeString(container.ToString()));
      ...
      public FolderResponse getFolder (string container, string folder_path, bool include_properties, bool include_folders, bool include_files, bool full_tree, bool zip) {
        // create path and map variables
        var path = "/app/{container}/{folder_path}/".Replace("{format}","json").Replace("{" + "container" + "}", apiInvoker.escapeString(container.ToString())).Replace("{" + "folder_path" + "}", apiInvoker.escapeString(folder_path.ToString()));
      ...
      public FileResponse getFile (string container, string file_path, bool include_properties, bool content, bool download) {
        // create path and map variables
        var path = "/app/{container}/{file_path}".Replace("{format}","json").Replace("{" + "container" + "}", apiInvoker.escapeString(container.ToString())).Replace("{" + "file_path" + "}", apiInvoker.escapeString(file_path.ToString()));
