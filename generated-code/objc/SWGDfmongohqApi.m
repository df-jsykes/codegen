...
@implementation SWGDfmongohqApi
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(SWGDfmongohqApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static SWGDfmongohqApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[SWGDfmongohqApi alloc] init];
...
-(void) getTablesWithCompletionBlock:(NSNumber*) include_properties
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/dfmongohq", basePath];
...
-(void) getRecordsWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/dfmongohq/{table_name}", basePath];
...
-(void) getRecordWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/dfmongohq/{table_name}/{id}", basePath];
