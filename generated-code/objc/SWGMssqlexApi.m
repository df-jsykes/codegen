...
@implementation SWGMssqlexApi
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(SWGMssqlexApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static SWGMssqlexApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[SWGMssqlexApi alloc] init];
...
-(void) getTablesWithCompletionBlock:(NSNumber*) include_properties
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/mssqlex", basePath];
...
-(void) getRecordsWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/mssqlex/{table_name}", basePath];
...
-(void) getRecordWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/mssqlex/{table_name}/{id}", basePath];
