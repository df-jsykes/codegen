...
@implementation SWGRFS_AWSApi
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(SWGRFS_AWSApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static SWGRFS_AWSApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[SWGRFS_AWSApi alloc] init];
...
-(void) getContainersWithCompletionBlock:(NSNumber*) include_properties
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/RFS_AWS", basePath];
...
-(void) getContainerWithCompletionBlock:(NSString*) container
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/RFS_AWS/{container}/", basePath];
...
-(void) getFolderWithCompletionBlock:(NSString*) container
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/RFS_AWS/{container}/{folder_path}/", basePath];
...
-(void) getFileWithCompletionBlock:(NSString*) container
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/RFS_AWS/{container}/{file_path}", basePath];
