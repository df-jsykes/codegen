...
@implementation SWGMongohqryApi
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(SWGMongohqryApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static SWGMongohqryApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[SWGMongohqryApi alloc] init];
...
-(void) getTablesWithCompletionBlock:(NSNumber*) include_properties
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/mongohqry", basePath];
...
-(void) getRecordsWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/mongohqry/{table_name}", basePath];
...
-(void) getRecordWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/mongohqry/{table_name}/{id}", basePath];
