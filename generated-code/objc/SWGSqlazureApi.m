...
@implementation SWGSqlazureApi
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(SWGSqlazureApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static SWGSqlazureApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[SWGSqlazureApi alloc] init];
...
-(void) getTablesWithCompletionBlock:(NSNumber*) include_properties
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/sqlazure", basePath];
...
-(void) getRecordsWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/sqlazure/{table_name}", basePath];
...
-(void) getRecordWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/sqlazure/{table_name}/{id}", basePath];
