...
@implementation SWGSalesforceApi
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(SWGSalesforceApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static SWGSalesforceApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[SWGSalesforceApi alloc] init];
...
-(void) getTablesWithCompletionBlock:(NSNumber*) include_properties
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/salesforce", basePath];
...
-(void) getRecordsWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/salesforce/{table_name}", basePath];
...
-(void) getRecordWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/salesforce/{table_name}/{id}", basePath];
