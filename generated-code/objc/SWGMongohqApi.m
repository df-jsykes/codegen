...
@implementation SWGMongohqApi
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(SWGMongohqApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static SWGMongohqApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[SWGMongohqApi alloc] init];
...
-(void) getTablesWithCompletionBlock:(NSNumber*) include_properties
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/mongohq", basePath];
...
-(void) getRecordsWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/mongohq/{table_name}", basePath];
...
-(void) getRecordWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/mongohq/{table_name}/{id}", basePath];
