...
@implementation SWGUserResponse
...
-(id) initWithValues:(NSDictionary*)dict
{
    ...
    if(self) {
        ...
        _default_app = [[SWGApp alloc]initWithValues:default_app_dict];
        id role_dict = dict[@"role"];
        _role = [[SWGRole alloc]initWithValues:role_dict];
...
-(NSDictionary*) asDictionary {
    ...
    if(_default_app != nil){
        if([_default_app isKindOfClass:[NSArray class]]){
            ...
            for( SWGApp *default_app in (NSArray*)_default_app) {
    ...
    if(_role != nil){
        if([_role isKindOfClass:[NSArray class]]){
            NSMutableArray * array = [[NSMutableArray alloc] init];
            for( SWGRole *role in (NSArray*)_role) {
