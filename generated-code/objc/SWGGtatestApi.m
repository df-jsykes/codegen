...
@implementation SWGGtatestApi
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(SWGGtatestApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static SWGGtatestApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[SWGGtatestApi alloc] init];
...
-(void) getContainersWithCompletionBlock:(NSNumber*) include_properties
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/gtatest", basePath];
...
-(void) getContainerWithCompletionBlock:(NSString*) container
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/gtatest/{container}/", basePath];
...
-(void) getFolderWithCompletionBlock:(NSString*) container
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/gtatest/{container}/{folder_path}/", basePath];
...
-(void) getFileWithCompletionBlock:(NSString*) container
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/gtatest/{container}/{file_path}", basePath];
