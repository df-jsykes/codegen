...
@implementation SWGSf_leetest2Api
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(SWGSf_leetest2Api*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static SWGSf_leetest2Api* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[SWGSf_leetest2Api alloc] init];
...
-(void) getTablesWithCompletionBlock:(NSNumber*) include_properties
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/sf_leetest2", basePath];
...
-(void) getRecordsWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/sf_leetest2/{table_name}", basePath];
...
-(void) getRecordWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/sf_leetest2/{table_name}/{id}", basePath];
