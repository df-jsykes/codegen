...
@implementation SWGDynamoDBApi
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(SWGDynamoDBApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static SWGDynamoDBApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[SWGDynamoDBApi alloc] init];
...
-(void) getTablesWithCompletionBlock:(NSNumber*) include_properties
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/DynamoDB", basePath];
...
-(void) getRecordsWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/DynamoDB/{table_name}", basePath];
...
-(void) getRecordWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/DynamoDB/{table_name}/{id}", basePath];
