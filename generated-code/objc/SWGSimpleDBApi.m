...
@implementation SWGSimpleDBApi
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(SWGSimpleDBApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static SWGSimpleDBApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[SWGSimpleDBApi alloc] init];
...
-(void) getTablesWithCompletionBlock:(NSNumber*) include_properties
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/SimpleDB", basePath];
...
-(void) getRecordsWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/SimpleDB/{table_name}", basePath];
...
-(void) getRecordWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/SimpleDB/{table_name}/{id}", basePath];
