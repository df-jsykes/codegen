...
@implementation SWGSftest3Api
static NSString * basePath = @"https://next.cloud.dreamfactory.com/rest";

@synthesize queue = _queue;
@synthesize api = _api;

+(SWGSftest3Api*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static SWGSftest3Api* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[SWGSftest3Api alloc] init];
...
-(void) getTablesWithCompletionBlock:(NSNumber*) include_properties
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/sftest3", basePath];
...
-(void) getRecordsWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/sftest3/{table_name}", basePath];
...
-(void) getRecordWithCompletionBlock:(NSString*) table_name
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/sftest3/{table_name}/{id}", basePath];
