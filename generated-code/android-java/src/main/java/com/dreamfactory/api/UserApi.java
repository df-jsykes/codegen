...
public class UserApi {
  ...
  public PasswordResponse changePassword (Boolean reset, PasswordRequest body) throws ApiException {
    // verify required params are set
    if(body == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  public Success register (Register body) throws ApiException {
    // verify required params are set
    if(body == null ) {
       throw new ApiException(400, "missing required params");
    }
