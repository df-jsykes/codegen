...
public class SchemaApi {
  ...
  public TableSchema describeTable (String table_name) throws ApiException {
    ...
    // create path and map variables
    String path = "/schema/{table_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString()));
  ...
  public FieldSchema describeField (String table_name, String field_name) throws ApiException {
    ...
    // create path and map variables
    String path = "/schema/{table_name}/{field_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString())).replaceAll("\\{" + "field_name" + "\\}", apiInvoker.escapeString(field_name.toString()));
